...
export async function POST(req) {
    ...
    // Se il target è PDF, non è necessaria la conversione – restituisci il file originale
    if (targetFormat === "pdf") {
    ...
    // Determina l'endpoint API di Cloudmersive in base al formato target (supporta PNG e JPEG)
    let endpoint = "";
    if (targetFormat === "png") {
